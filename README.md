...
> **Journal:** BMC Genomics (Under Review)  
...
All figures in the manuscript are generated by `08_tf_dfe_model.py` and saved to `results_publication/` as both `.png` and `.tiff` (300 DPI, BMC Genomics format).
...
```
Ahamed A, Hasan MT, Tabassum MA, Hossain A, Kamruzzaman M, Das J, Imon AHMR.
Topology-Guided Multi-View Ensemble Learning for Evidence-Aware Somatic Variant 
Pathogenicity Classification in Cancer Genomics.
BMC Genomics (Under Review), 2026.
```
